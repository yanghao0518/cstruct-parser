...
import com.haoyu.module.jcstruct.refresh.RefreshServiceManagerService;
 ...
 *
 */
public class CjavaRefreshManagerBeanDefinitionParser extends AbstractSingleBeanDefinitionParser
{

	private String defaultClass = "com.haoyu.module.jcstruct.refresh.RefreshServiceManager";
	private String defaultId = "refreshServiceManager";

	@Override
	protected Class<?> getBeanClass(Element element)
	{
		return RefreshServiceManagerService.class;
	}
